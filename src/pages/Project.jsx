...
const Project = () => {
  ...
  return (
    <div className="lg:p-16 sm:p-5  xl:w-3/4 xl:m-auto w-full  2xl:w-2/4 ">
      ...
      <div className="flex sm:flex-col gap-5 sm:items-center lg:items-start">
        <a
          target="blanck"
          className="hover:scale-105 transition-all bg-green-500 text-white p-4 rounded-md block sm:w-2/4 w-1/4 text-center m-auto font-bold"
          href={project.url}
        >
          Demo
        </a>
